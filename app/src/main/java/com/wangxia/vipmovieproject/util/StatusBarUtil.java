...
public class StatusBarUtil {
    ...
    public static void setColor(Activity activity, @ColorInt int color) {
        setColor(activity, color, 0); //默认透明度原来是112,现在改成0,就是全透明
    }
    ...
    public static void setTranslucentForImageViewInFragment(Activity activity, View needOffsetView) {
        setTranslucentForImageViewInFragment(activity, 75, needOffsetView); //设置透明度
    }

    public static void setTranslucent_trans(Activity activity, View needOffsetView) {
        setTranslucentForImageViewInFragment(activity, 0, needOffsetView); //完全透明的
    }
